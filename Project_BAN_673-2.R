...
## Training partition captures data with strong trend but non-significant seasonality.
...
#Accuracy for Model 3a: Regression model with linear trend
round(accuracy(united.lin$fitted, united.ts),3)

#Accuracy for Model 3b:  Regression Model with Exponential Trend:
round(accuracy(united.expo$fitted, united.ts),3)

#Accuracy for Model 3c:Regression mode with quadratic trend
round(accuracy(united.quad$fitted, united.ts),3)

#Accuracy for Model 3d:Regression mode with 3rd Order (polynomial) trend
round(accuracy(united.cube$fitted, united.ts),3)

#Accuracy for Model 4:Regression model with seasonality
round(accuracy(united.season$fitted, united.ts),3)

#Accuracy for Model 5: Regression model with Exponential trend and seasonality.  
round(accuracy(united.expotrend.season$fitted, united.ts),3)

#Accuracy for Model 5: Regression model with 3rd Order(Polynomial) trend and seasonality.  
round(accuracy(united.cubetrend.season$fitted, united.ts),3)
#-----------------------------------------------------------------------------------------------------------------------------
